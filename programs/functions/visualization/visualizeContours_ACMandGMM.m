function [ Pros ] = visualizeContours_ACMandGMM( Pros, image_original, image_processed, phi, bwData, Pix, Px, Pxi, Pi )
...
if  ( ( (strcmp(Pros.isVisualEvolution,'yes')==1) && (Pros.iteration_outer==1 || Pros.iteration_outer==Pros.numIteration_outer || mod(Pros.iteration_outer,Pros.periodOfVisual)==0) ) ...
	...
	temp060=reshape(Pi(:,1) ,Pros.sizeOfImage(1),Pros.sizeOfImage(2));
	...
	temp065=reshape(Pi(:,2) ,Pros.sizeOfImage(1),Pros.sizeOfImage(2));
