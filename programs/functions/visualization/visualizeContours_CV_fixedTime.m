function [ Pros ] = visualizeContours_CV_fixedTime(Pros, image_original, image_processed, phi, bwData, areaTerm ,regularTerm , edgeTerm, diracPhi, DeltaPhi )
%visualizeContours_CV_fixedTime 此处显示有关此函数的摘要
%   此处显示详细说明
