function [segOutline, imgMarkup,RGBImgMarkup]=fun_visual_SpSegmentations( img,RGBImg, segmentsValue, SP_center_position,numSP,Pros)
...
title('超像素边界');
for i=1:1:numSP
    text(SP_center_position(i,2),SP_center_position(i,1), num2str(i),'FontSize',8); % 显示标号
end
subplot(3,1,2);
imshow(imgMarkup);
