function [ EachImage ] = createEachImageStructureForSegmentation(folderpath_resourcesBaseFolder, folderpath_initMethodBase, numUselessFiles)
...
EachImage.folderpath_originalReources =[ folderpath_resourcesBaseFolder ];	  % 基础资源文件（原图、真值图、标记图）的基本路径
EachImage.folderpath_initResources =[ folderpath_initMethodBase ];	% 基础初始化文件（各种初始化方法生成的如初始轮廓二值图、各参数、时间参数等）的基本路径
