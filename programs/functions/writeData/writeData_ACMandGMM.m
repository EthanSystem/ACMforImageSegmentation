function [Pros] = writeData_ACMandGMM(Pros, image_original, image_processed, phi,  bwData, Pix, Px, Pxi, P_x_and_i, Pi_vis, Pi, mu, Sigma)
%writeData_ACMandGMM 保存在程序运行过程中产生的数据，并不是每一代都保存，而是保存给定迭代周期的数据
%   input:
% Pros：结构体
