...
Args.folderpath_EachImageBaseFolder = '.\data\resources\circleACMGMM 5-28挑出来\要做kmeans+AMCGMM聚类的'; % 用于提取文件的结构体 EachImage 的基本路径
...
Args.folderpath_ResultsBaseFolder = '.\data\evaluation\circleACMGMM 5-28挑出来\要做kmeans+AMCGMM聚类的\end0.001'; % 用于提取文件的结构体 Results 的基本路径。
Args.folderpath_outputBase = '.\data\extract\circleACMGMM_epsilon0.5_sigma0.3 5-28挑出来\要做kmeans+AMCGMM聚类的\end0.001'; % 提取文件的目标文件夹
