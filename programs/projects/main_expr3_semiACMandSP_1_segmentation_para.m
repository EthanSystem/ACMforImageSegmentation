...
%% 路径设置项
Args.folderpath_EachImageResourcesBaseFolder = '.\data\resources\MSRA1K 30 images\original resources';

folderpath_EachImageInitBaseFolder{1} = '.\data\resources\MSRA1K 30 images\init resources\scribbled_circle_SDF_kmeans100_2';

Args.folderpath_ResultsBaseFolder = '.\data\expr3_semiACMGMMSP_para\para_3' ;
...
%% ACMGMMandSPsemisupervised_1 测试分析专用 %%%%%%%%%%%%%%%%%%%%%%%%%%%
i=0;
for initMethod=folderpath_EachImageInitBaseFolder
    ...
    Args.foldername_experiment =['semiACMGMMSP_1' '_' datestr(now,'ddHHMMSS')];
    Args = setSegmentationMethod(Args, Args.evolutionMethod);
    segmentation_func(Args);
end

%% evolution_ACMGMMandSPsemisupervised_1 在 不同参数下的批处理试验1 %%%%%%%%%%%%%%
% Args.evolutionMethod='semiACMGMMSP_1';
% Args=setSegmentationMethod(Args, Args.evolutionMethod);
% i=0;
% for initMethod=folderpath_EachImageInitBaseFolder
...
%% evolution_ACMGMMandSPsemisupervised_1 在 不同参数下的批处理试验2 %%%%%%%%%%%%%%
% Args.evolutionMethod='semiACMGMMSP_1';
% Args=setSegmentationMethod(Args, Args.evolutionMethod);
% i=0;
% for initMethod=folderpath_EachImageInitBaseFolder
...
%% evolution_ACMGMMandSPsemisupervised_1 在 不同参数下的批处理试验3 %%%%%%%%%%%%%%
% Args.evolutionMethod='semiACMGMMSP_1';
% Args=setSegmentationMethod(Args, Args.evolutionMethod);
% i=0;
% idx_smallNumber=0;
